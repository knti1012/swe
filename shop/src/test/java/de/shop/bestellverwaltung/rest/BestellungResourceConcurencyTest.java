...
public class BestellungResourceConcurencyTest extends AbstractResourceTest {
	private static final Logger LOGGER = Logger.getLogger(MethodHandles.lookup().lookupClass().getName());
	
//	private static final Long ARTIKEL_ID_UPD_DEL = Long.valueOf(10007);
	private static final Long BESTELLUNG_ID_UPD_UPD = Long.valueOf(1000);
	private static final String NEUER_STATUS = "in Bearbeitung";
	private static final String NEUER_STATUS_2 = "storniert";
	...
	public void updateUpdate() throws InterruptedException, ExecutionException {
		...
		final Long bestellungId = BESTELLUNG_ID_UPD_UPD;
		final String username = USERNAME;
		final String password = PASSWORD;
    	final String neuerStatus = NEUER_STATUS;
    	final String neuerStatus2 = NEUER_STATUS_2;
