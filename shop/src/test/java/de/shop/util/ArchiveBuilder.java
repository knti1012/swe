...
public enum ArchiveBuilder {
	...
	private ArchiveBuilder() {
		...
		// }
		// final File warFile = Paths.get(arquillianPath.toString(),
		// TEST_WAR).toFile();
	...
	private void addWebInf() {
		...
		// Gibt es jboss-deployment-structure.xml fuer die Erweiterung des
		// Classpath?
		...
		// TODO MANIFEST.MF fuer Web-Archiv kann nicht mit ShrinkWrap gesetzt
		// werden
		// else {
		// archive.addAsManifestResource(new
		// StringAsset("Manifest-Version: 1.0\n"
	...
	private void addJars() {
		...
		archive.addAsLibraries(
				pomResolver.resolve("org.richfaces.ui:richfaces-components-ui")
						.withTransitivity().asFile()).addAsLibraries(
				pomResolver.resolve("org.richfaces.core:richfaces-core-impl")
